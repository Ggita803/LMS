...
import Lule from '../assets/team/Lule.jpeg';
...
const AboutPage = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      emoji: '👨‍💼',
      photo: mathias,
      bio: 'Expert in library science, dedicated to curating diverse collections and managing library resources.',
    ...
    {
      name: 'Mbazira Shafik',
      role: 'Library Operations Manager',
      emoji: '👩‍💼',
      photo: shafik,
      bio: 'Ensures smooth day-to-day operations and helps members get the most out of our library systems.',
    ...
    },
    {
      ...
      emoji: '👩‍💼',
      photo: victoria,
      bio: 'Builds strong relationships with our members and organizes wonderful events to bring readers together.',
    ...
    },
    {
      ...
      emoji: '👩‍💼',
      photo: vivian,
      bio: 'Plans exciting library programs, book clubs, and activities that bring our community together.',
      linkedin: 'https://linkedin.com/in/jamessmith',
      twitter: 'https://twitter.com/jamessmith',
      github: 'https://github.com/jamessmith',
    },
    {
      name: 'Achom Hannifah',
      role: 'Member Services Associate',
      emoji: '👩‍💼',
      photo: hanifah,
      bio: 'Provides friendly support to members and helps them navigate all our library services with ease.',
      linkedin: 'https://linkedin.com/in/jamessmith',
      twitter: 'https://twitter.com/jamessmith',
      github: 'https://github.com/jamessmith',
    },
    {
      ...
      emoji: '👩‍💼',
      photo: lucy,
      bio: 'Helps keep our library organized and ensures members have a welcoming, clean environment to enjoy.',
      linkedin: 'https://linkedin.com/in/jamessmith',
      twitter: 'https://twitter.com/jamessmith',
      github: 'https://github.com/jamessmith',
    },
    {
      ...
      emoji: '👨‍💼',
      photo: nobert,
      bio: 'Dedicated to answering questions and helping members resolve any issues quickly and kindly.',
      linkedin: 'https://linkedin.com/in/jamessmith',
      twitter: 'https://twitter.com/jamessmith',
      github: 'https://github.com/jamessmith',
    },
    {
      name: 'Lule Steven', 
      role: 'Book Inventory Coordinator',
      emoji: '👨‍💼',
      photo: Lule,
      bio: 'Makes sure our book collection is well-organized and easy to find, keeping everything running smoothly behind the scenes.',
      linkedin: 'https://linkedin.com/in/jamessmith',
      twitter: 'https://twitter.com/jamessmith',
      github: 'https://github.com/jamessmith',
    },
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
              {team.map((member, idx) => (
                ...
                >
                  ...
                  <h5 className="text-xs text-muted mb-1">{member.role}</h5>
